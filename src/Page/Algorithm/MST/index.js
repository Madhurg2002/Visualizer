            ...
            <div className="w-80 h-full bg-slate-900/80 backdrop-blur-xl border-l border-white/10 p-6 flex flex-col shadow-2xl z-20 overflow-y-auto">
                ...
                <div className="flex flex-col gap-6">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Graph Theory</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex bg-slate-800/50 rounded-lg p-1 border border-white/5">
                            <button onClick={() => {if(status!=='Running') setAlgoName('kruskals')}} className={`flex-1 py-2 rounded text-xs font-bold transition-all ${algoName==='kruskals' ? 'bg-emerald-500 text-white shadow-lg' : 'text-slate-400 hover:text-white'}`}>Kruskal's</button>
                            <button onClick={() => {if(status!=='Running') setAlgoName('prims')}} className={`flex-1 py-2 rounded text-xs font-bold transition-all ${algoName==='prims' ? 'bg-cyan-500 text-white shadow-lg' : 'text-slate-400 hover:text-white'}`}>Prim's</button>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            <div className="flex justify-between text-xs font-bold text-slate-500 mb-1">
                                <span>Nodes</span>
                                <span className="text-emerald-400 font-mono">{nodeCount}</span>
                            </div>
                            <input 
                        ...
                        <div>
                            <div className="flex justify-between text-xs font-bold text-slate-500 mb-1">
                                <span>Speed</span>
                                <span className="text-emerald-400 font-mono">{505 - speed}ms</span>
                            </div>
                            <input 
